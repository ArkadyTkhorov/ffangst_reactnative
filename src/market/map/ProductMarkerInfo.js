...
class ProductMarkerInfo extends Component {
  ...
  render() {
    ...
    return (
      <View style={centered ? styles.containerCentered : styles.containerSided}>
        <View style={styles.header}>
          <Touchable onPress={onClose}>
            <Icon name="close" size={24} color={palette[0]} style={styles.closeButton} />
          </Touchable>
        </View>
          ...
          <View style={styles.body}>
            {product.image != null ? (
              ...
              <View style={styles.imagePlaceholder}>
                <Icon name="image" size={48} color={`${palette[3]}30`} />
              </View>
            )}
            <View style={styles.info}>
              <View style={styles.infoRow}>
                ...
                <Text numberOfLines={1}>{product.address ? product.address : ' '}</Text>
              </View>
